...
;CHECK-NEXT:entry:
;CHECK-NEXT:  call void @cblas_dgemm(i32 102, i32 112, i32 112, i32 4, i32 3, i32 2, double %alpha, double* nocapture readonly %A, i32 2, double* nocapture readonly %B, i32 3, double %beta, double* %C, i32 4)
...
;CHECK-NEXT:  call void @cblas_dgemm(i32 102, i32 111, i32 111, i32 2, i32 3, i32 4, double %alpha, double* nocapture readonly %A, i32 2, double* nocapture readonly %"C'", i32 4, double 1.000000e+00, double* %"B'", i32 2)
