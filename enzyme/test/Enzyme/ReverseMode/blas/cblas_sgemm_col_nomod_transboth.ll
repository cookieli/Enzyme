...
@__const.main.B = private unnamed_addr constant [6 x float] [float 1.011000e+03, float 1.021000e+03, float 1.031000e+03, float 1.012000e+03, float 1.022000e+03, float 1.032000e+03], align 16
...
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %5, i8* align 16 bitcast ([12 x float]* @__const.main.C1 to i8*), i64 48, i1 false)
...
;CHECK-NEXT:entry:
;CHECK-NEXT:  call void @cblas_sgemm(i32 102, i32 112, i32 112, i32 4, i32 3, i32 2, float %alpha, float* nocapture readonly %A, i32 2, float* nocapture readonly %B, i32 3, float %beta, float* %C, i32 4)
;CHECK-NEXT:  call void @cblas_sgemm(i32 102, i32 111, i32 111, i32 4, i32 2, i32 3, float %alpha, float* nocapture readonly %"C'", i32 4, float* nocapture readonly %B, i32 3, float 1.000000e+00, float* %"A'", i32 4)
;CHECK-NEXT:  call void @cblas_sgemm(i32 102, i32 111, i32 111, i32 2, i32 3, i32 4, float %alpha, float* nocapture readonly %A, i32 2, float* nocapture readonly %"C'", i32 4, float 1.000000e+00, float* %"B'", i32 2)
