...
;    cblas_sgemm(CblasRowMajor, CblasNoTrans, CblasTrans, 2, 4, 3, alpha, A, 3, B, 3, beta, C, 4);
;}
;
;int main() {
;    float A[] = { 1, 2, 3,
...
@__const.main.A = private unnamed_addr constant [6 x float] [float 1.000000e+00, float 2.000000e+00, float 3.000000e+00, float 4.000000e+00, float 5.000000e+00, float 6.000000e+00], align 16
...
entry:
  ...
  call void @cblas_sgemm(i32 101, i32 111, i32 112, i32 2, i32 4, i32 3, float %0, float* %1, i32 3, float* %2, i32 3, float %3, float* %4, i32 4)
  ret void
}
...
;CHECK-NEXT:entry:
;CHECK-NEXT:  call void @cblas_sgemm(i32 101, i32 111, i32 112, i32 2, i32 4, i32 3, float %alpha, float* nocapture readonly %A, i32 3, float* nocapture readonly %B, i32 3, float %beta, float* %C, i32 4)
...
;CHECK-NEXT:  call void @cblas_sgemm(i32 101, i32 112, i32 111, i32 3, i32 4, i32 2, float %alpha, float* nocapture readonly %A, i32 3, float* nocapture readonly %"C'", i32 4, float 1.000000e+00, float* %"B'", i32 4)
